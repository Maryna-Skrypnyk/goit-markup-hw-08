...
// Модуль 6 Задача№7
// Замени объявление функции filterArray() и 
...
// Модуль 6 Задача№8
// Замени объявление функции getCommonElements() и коллбек 
...
// не изменяла массив чисел numbers, а создавала, наполняла 
...
//   const newArray = [];
//   numbers.forEach(number => {
//       number % 2 === 0 ? newArray.push(number + value) :
...
// чтобы в переменной genres получился массив всех жанров книг 
...
// чтобы она возвращала массив почтовых адресов 
...
// из массива numbers, а в переменной oddNumbers 
...
// Модуль 6 Задача№16
// Дополни код так, чтобы в переменной allGenres был 
...
// возраст которых(свойство age) попадает 
...
// чтобы она возвращала массив неактивных пользователей, 
...
// автор который(свойство author) совпадает со 
...
// console.log(getUserWithEmail(users, 'mary@gmail.com'));
...
// чтобы она проверяла наличие активных пользователей(свойство isActive) 
...
// среднего времени проведённого в играх.
// Дополни код так, чтобы в переменной 
...
// чтобы она считала и возвращала общее количество 
...
// по алфавиту копия массива authors, а в переменной 
...
// const sortedByAuthorName = [...books].sort((firstAutor, secondAutor) => firstAutor.author.localeCompare(secondAutor.author));

// const sortedByReversedAuthorName = [...books].sort((firstAutor, secondAutor) => secondAutor.author.localeCompare(firstAutor.author));
...
//    const sortBalance = [...users].sort((firstBalance, secondBalance) => firstBalance.balance - secondBalance.balance);
...
//   const sortFriendCount = [...users].sort((firstFriends, secondFriends) => secondFriends.friends.length - firstFriends.friends.length);
...
//    const sortName = [...users].sort((firstName, secondName) => firstName.name.localeCompare(secondName.name));
